...
void sha256(const unsigned char *data, size_t len,char *sha256str) {
    ...
    sprintf(sha256str,"%08x%08x%08x%08x%08x%08x%08x%08x",out[0],out[1],out[2],out[3],out[4],out[5],out[6],out[7]);
    /*for(int i=0;i<32;i++)
	{
		printf("%x",out[i]);
	}*/
